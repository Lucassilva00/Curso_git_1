# funciona como h1 do html, ## h2 e assim por diante.
negrito = __palavra__ ou **palavra**
itálico = _palavra_ ou *palavra*

lista sem ordenação = * item
...
Adicionar código ao readme. obs: Não é aspas simples
```linguagem_usada
código
```
